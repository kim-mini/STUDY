...
class MyApp(QWidget):
    ...
    def createSecondExclusiveGroup(self):
        ...
        groupbox.setChecked(False)#기본값이 체크해제
        ...
        vbox.addStretch(1)# 맨밑에 공간을 띄워준다
        groupbox.setLayout(vbox)
    ...
    def createPushButtonGroup(self):
        ...
        flatbutton.setFlat(True)#플랫스타일의 버튼
